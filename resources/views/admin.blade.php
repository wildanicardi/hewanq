...
<div class="row">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-8">
                  <p class="text-center">
                    <strong>Kamis 5 Desember 2018</strong>
                  </p>
    ...
    <section class="content">
      ...
      <div class="row">
              ...
              <h2>Read Data</h2>
    <hr/>
    <a class="btn btn-primary" href="{{route('user.form')}}" style="margin-bottom: 15px;">Create New</a>

    @if(Session::has('message'))
    <div class="alert-custom">
        <p>BERHASIL DI BUAT</p>
    </div>
    @endif()
        ...
        @foreach($user as $users)
             <tr>
                 ...
                 <form action="/admin/admin/user/{!! $users->id !!}" method="post" id="form_aksi">
                        <a href="/admin/admin/user/{!! $users->id !!}/edit" class="btn btn-success"><i class="fa fa-pencil"></i>edit</a>
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
